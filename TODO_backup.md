...
- [ ] **步骤 8.6**: 调用 `playwright` 截图测试（桌面端、移动端）
- [ ] **步骤 8.7**: 修复问题并提交
- [ ] **检查点**:
  - 关键状态：导航栏组件开发完成
...
- [ ] **步骤 15.4**: 调用 `systematic-debugging` 测试 Tab 切换
- [ ] **步骤 15.5**: 提交代码
- [ ] **检查点**:
  - 关键状态：Tab 选项卡组件开发完成
  - 结果日志：Tab 切换功能测试通过
...
- [ ] **步骤 22.4**: 调用 `systematic-debugging` 测试折叠功能
- [ ] **步骤 22.5**: 提交代码
- [ ] **检查点**:
  - 关键状态：FAQ 组件开发完成
  - 结果日志：折叠动画测试通过
